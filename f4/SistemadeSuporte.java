...
public class SistemadeSuporte
{
   ...
   /**
    * i) insere um novo pedido de suporte no sistema conseguiiii
    */ 
   ...
   /**
    * v) devolve o colaborador que resolveu mais pedidos conseguiii
    */ 
...
/**
 * vi) devolve os pedidos resolvidos num dado periodo de tempo conseguiii
 */        
...
/**
 * viii) calcula a media de minutos... conseguiii
 */
...
/**
 * ix) devolve o pedido que demorou mais tempo a ser resolvido conseguiii
 */
...
/**
 * xi) devolve o pedido que demorou menos tempo a resolver conseguiiii
 */
